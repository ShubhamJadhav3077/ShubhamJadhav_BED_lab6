...
public class WebSecurity {
	// ADMIN credentials: username:- elon , password:- musk
	// USER credentials: username:- bill , password:- gates
	// These credentials are stored in collegedb database in mySQL with encrypted
	// password using bcrpyt encoder
	@Bean
